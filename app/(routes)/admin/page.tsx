    ...
    <div className="flex-1 flex flex-col p-3 gap-3 bg-[#F1F2F8]">
      ...
      <div className="px-1.5 grid grid-cols-4 grid-rows-2 gap-2.5">
        {dashboardCards.map((card) => (
          <div className="flex flex-col gap-2 py-4 px-3.5 bg-white items-center justify-center rounded-[8px] shadow-[0px_2px_4px_-2px_rgba(0,0,0,0.1),0px_4px_6px_-1px_rgba(0,0,0,0.1)]">
